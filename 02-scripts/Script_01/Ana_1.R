...
load_and_rename(file.path(data_read,"ASPDX_CC_seuratObj.RData"), "seurat_ASPDX")
load_and_rename(file.path(data_read,"AS3D_CC_seuratObj.RData"), "seurat_AS3D")
load_and_rename(file.path(data_read,"AS_seuratObj.RData"), "seurat_AS")
...
ggsave(file.path(analysis_save, "UMAP_of_CC.pdf"), p1, width = 12, height = 12)
...
ggsave(file.path(analysis_save,"UMAP_of_CC_in_Samples.pdf"), p2, width = 8, height = 6)
...
ggsave(file.path(analysis_save,"UMAP_of_CC_Cycle.pdf"), p3, width = 8, height = 6)
...
ggsave(file.path(analysis_save,"lineplot_of_CC_among_Samples.pdf"), p4, width = 16, height = 6)
...
ggsave(file.path(analysis_save,"Barplot_of_CC_Samples.pdf"), p5, width = 5, height = 6)
...
ggsave(file.path(analysis_save,"Barplot_of_CC_Cell_Cycle.pdf"), p6, width = 10, height = 4)
...
ggsave(file.path(analysis_save,"Barplot_of_Sample_in_CC.pdf"), p7, width = 10, height = 4)

# Save integrated Seurat object and metadata ------------------------------
save(immune.combined, file = file.path(data_save,"Integrated_seurat_AS_AS3D_ASPDX_HVG5000.RData"))
...
pdf(file.path(analysis_save,"Distribution_CC_in_Samples.pdf"), width = 12, height = 8)
pheatmap(
...
dir.create(file.path(data_save,"Velocyto"))
write.csv(immune.combined@meta.data, file.path(data_save,"Velocyto/Metadata.csv"))
write.csv(Embeddings(immune.combined, 'umap'), file.path(data_save,"Velocyto/UMAP_embedding.csv"))
